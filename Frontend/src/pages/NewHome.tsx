import { ArrowRight, Check, ChevronDown, Code, Cpu, Wand2, Zap } from 'lucide-react';
...
export function Home() {
  ...
  return (
    <div className="bg-gray-950 min-h-screen">
      ...
      <header className="relative overflow-hidden bg-gray-950">
        ...
        <nav className="relative z-10 flex items-center justify-between p-6 lg:px-12">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="#why-choose" className="text-gray-300 hover:text-white transition-colors">Why Choose</a>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32 lg:px-8 lg:py-40">
          <div className="md:flex md:items-center md:space-x-12">
            <div className="md:w-1/2 space-y-8">
              ...
              >
                Prompt, run, edit, and deploy full-stack web applications without writing a single line of code.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Everything you need to build, test, and deploy web applications in minutes.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Describe your website in natural language and watch as Bolt generates all the code and assets for you."
              },
              {
                icon: <Code className="w-8 h-8 text-blue-400" />,
                title: "Integrated Code Editor",
                description: "Make precise adjustments with our fully-featured code editor with syntax highlighting and autocompletion."
              },
              {
                icon: <Zap className="w-8 h-8 text-blue-400" />,
                title: "Instant Preview",
                description: "See changes in real-time with our built-in preview that updates as you modify your application."
              },
              {
                icon: <Cpu className="w-8 h-8 text-blue-400" />,
                title: "WebContainer Technology",
                description: "Run your web applications directly in the browser with our cutting-edge WebContainer technology."
              },
              {
                icon: <Check className="w-8 h-8 text-blue-400" />,
                title: "Step-by-Step Guidance",
                description: "Follow our intuitive step-by-step process to bring your web application from concept to completion."
              },
              {
                icon: <ArrowRight className="w-8 h-8 text-blue-400" />,
                title: "One-Click Deployment",
                description: "Deploy your application to the web with a single click and share it with the world."
              }
            ].map((feature, index) => (
              <motion.div 
                key={index}
      ...
      {/* Why Choose Section */}
      <section id="why-choose" className="py-20 bg-gray-950 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#1a365d,transparent_70%)]"></div>
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Bolt?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              The fastest way to transform your ideas into fully functional web applications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <motion.div 
              ...
              transition={{ duration: 0.5 }}
            >
              <h3 className="text-2xl font-bold text-white mb-6">For Non-Technical Users</h3>
              <ul className="space-y-4">
                {[
            ...
            {[
              {
                ...
                answer: "Bolt uses advanced AI to interpret your natural language description and generate the necessary code to create a fully functional website. It analyzes your requirements and produces HTML, CSS, and JavaScript files that match your vision."
              },
              {
                question: "Can I customize the generated website?",
                answer: "Absolutely! Bolt provides a full-featured code editor where you can make precise adjustments to any aspect of your website. The changes are reflected in real-time in the preview window."
              },
              {
                question: "What kind of websites can I create with Bolt?",
                answer: "Bolt can help you create a wide range of websites, from simple landing pages to complex web applications with dynamic functionality. It's suitable for portfolios, blogs, e-commerce sites, dashboards, and more."
              },
              {
                question: "Do I need coding experience to use Bolt?",
                answer: "No coding experience is required. Bolt is designed to be accessible to everyone, regardless of technical background. However, if you do have coding experience, you can leverage it to make more advanced customizations."
              },
              {
                question: "How do I deploy my website?",
                answer: "Bolt offers a one-click deployment feature that allows you to publish your website to the internet instantly. You can also export your project files to deploy through other hosting services."
              }
            ].map((faq, index) => (
              <motion.div 
                key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Build websites with AI-powered simplicity. Turn your ideas into reality in minutes.
              </p>
